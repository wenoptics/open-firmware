...
class LSM6DSLCore {
public:
    LSM6DSLCore(TwoWire *i2cPeri, uint8_t pSDA, uint8_t pSCL, lsm6dsl_mode_t operationMode, uint8_t arg);
    LSM6DSLCore(TwoWire *i2cPeri, uint8_t pSDA, uint8_t pSCL, uint8_t addr);
    ~LSM6DSLCore() = default;
...
public:
    ...
    LSM6DSL(TwoWire *i2c = &Wire, uint8_t pSDA = PIN_WIRE_SDA, uint8_t pSCL = PIN_WIRE_SCL, uint8_t address = 0x6B);
    LSM6DSL(TwoWire *i2c = &Wire, uint8_t pSDA = PIN_WIRE_SDA, uint8_t pSCL = PIN_WIRE_SCL, lsm6dsl_mode_t mode = LSM6DSL_MODE_I2C, uint8_t arg = 0x6B);
    ~LSM6DSL() = default;
